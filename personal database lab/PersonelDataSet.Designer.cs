...
namespace personal_database_lab {
    ...
    public partial class PersonelDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string Name, string Position, decimal HourlyPayRate) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public decimal HourlyPayRate {
                get {
                    return ((decimal)(this[this.tableTable.HourlyPayRateColumn]));
                }
                set {
                    this[this.tableTable.HourlyPayRateColumn] = value;
                }
            }
        }
...
namespace personal_database_lab.PersonelDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name" +
                "] = @Original_Name) AND ([Position] = @Original_Position) AND ([HourlyPayRate] =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Position], [HourlyPayRate]) VALUES (@Name, @P" +
                "osition, @HourlyPayRate);\r\nSELECT EmployeeID, Name, Position, HourlyPayRate FROM" +
                " [Table] WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Name] = @Name, [Position] = @Position, [HourlyPayRate] = @HourlyPayRate WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([HourlyPayRate] = @Original_HourlyPayRate));
SELECT EmployeeID, Name, Position, HourlyPayRate FROM [Table] WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::personal_database_lab.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, Position, HourlyPayRate FROM dbo.[Table]";
        ...
        public virtual int Fill(PersonelDataSet.TableDataTable dataTable) {
        ...
        public virtual PersonelDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PersonelDataSet.TableDataTable dataTable = new PersonelDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PersonelDataSet.TableDataTable dataTable) {
